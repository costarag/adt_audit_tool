	...
	<div class="container" style="display: none">
		...
		<div id="tabs" style="padding: 15px">
			<ul id="tabs_ul">
				...
				<li><a href="#gcdpi"><span>GCDPi</span></a></li>
				<li><a href="#gcdpo"><span>GCDPo</span></a></li>
				<li><a href="#gipo"><span>GIPo</span></a></li>
				<li><a href="#gipi"><span>GIPi</span></a></li>
				<li><a href="#term"><span>Terms</span></a></li>
...
$(document).ready(function() {
	...
	function loadForms(){
        ...
        $.getJSON("loadForms.php?cl=" + $("#clId").val() +"&period="+ $("#periodId").val(), function(data) {
            if(data.isMonthly == 1){
                /*
		        $("#tabs_ul").append("<ul id=\"tabs_ul\">");
		        $("#tabs_ul").append("<li><a href=\"#summary\"><span>Summary</span></a></li>");
		        $("#tabs_ul").append("<li><a href=\"#gcdpi\"><span>GCDPi</span></a></li>");
		        $("#tabs_ul").append("<li><a href=\"#gcdpo\"><span>GCDPo</span></a></li>");
		        $("#tabs_ul").append("<li><a href=\"#gipo\"><span>GIPo</span></a></li>");
		        $("#tabs_ul").append("<li><a href=\"#gipi\"><span>GIPi</span></a></li>");
		        $("#tabs_ul").append("</ul>");
		        
		        $("#tabs").append("<div id=\"summary\" align=\"center\"></div>");
		        $("#tabs").append("<div id=\"gcdpi\" align=\"center\"></div>");
		        $("#tabs").append("<div id=\"gcdpo\" align=\"center\"></div>");
		        $("#tabs").append("<div id=\"gipo\" align=\"center\"></div>");
		        $("#tabs").append("<div id=\"gipi\" align=\"center\"></div>");
		        ...
		        */
		        ...
		        $("#tabs_ul").append("<ul id=\"tabs_ul\">");
		        $("#tabs_ul").append("<li><a href=\"#summary\"><span>Summary</span></a></li>");
		        $("#tabs_ul").append("<li><a href=\"#legal\"><span>Legal</span></a></li>");
		        $("#tabs_ul").append("<li><a href=\"#term\"><span>Term</span></a></li>");
		        $("#tabs_ul").append("</ul>");

		        $("#tabs").append("<div id=\"summary\" align=\"center\"></div>");
		        $("#tabs").append("<div id=\"legal\" align=\"center\"></div>");
		        $("#tabs").append("<div id=\"term\" align=\"center\"></div>");
